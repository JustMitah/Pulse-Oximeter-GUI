 ...
 * @author Kazwell
 */
public class CreationPDF_Patient {
    	 public static void generatePatientDetails() throws FileNotFoundException, DocumentException {
             Document document = new Document();
		 try
		 {               
			PdfWriter.getInstance(document, new FileOutputStream("C:/Users/Kazwell/Documents/NetBeansProjects/PulseOximeter/src/pulseoximeter/constructors/"+"PatientDétails.pdf"));
			document.open();			 
			 ...
			 font.setSize(18);
			 String titre="Détails du Patient" ;
